...
// @ts-ignore
import { BusStopsRequestBuilderRequestsMetadata, type BusStopsRequestBuilder } from './busStops/';
// @ts-ignore
import { MsRequestBuilderRequestsMetadata, type MsRequestBuilder } from './ms/';
// @ts-ignore
...
export interface ApiClient extends BaseRequestBuilder<ApiClient> {
    /**
     * The busStops property
     */
    get busStops(): BusStopsRequestBuilder;
    /**
     * The ms property
     */
    get ms(): MsRequestBuilder;
}
/**
...
export function createApiClient(requestAdapter: RequestAdapter) {
    ...
    if (requestAdapter.baseUrl === undefined || requestAdapter.baseUrl === "") {
        requestAdapter.baseUrl = "http://localhost:44601";
    }
...
export const ApiClientNavigationMetadata: Record<Exclude<keyof ApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    busStops: {
        requestsMetadata: BusStopsRequestBuilderRequestsMetadata,
    },
    ms: {
        requestsMetadata: MsRequestBuilderRequestsMetadata,
    },
};
/* tslint:enable */
/* eslint-enable */
